...
SYMPTOM_POOL = [
    ...
    "鼻衄", "牙龈出血", "牙龈肿痛", "口腔溃疡", "咽异物感", "打鼾", "嗅觉减退", "听力下降", "耳痛", "耳闷",
    "颈部僵硬", "肩痛", "上肢麻木", "下肢麻木", "下肢水肿", "皮肤黄染", "皮肤干燥", "皮下结节", "关节僵硬", "活动受限",
    "肌肉无力", "肌肉萎缩", "步态不稳", "嗜睡", "惊厥", "心烦", "易怒", "胸骨后疼痛", "吞咽疼痛", "排便困难",
    "大便变细", "排尿困难", "尿不尽", "尿失禁", "蛋白尿", "眼睑水肿", "眼眶胀痛", "畏寒", "寒战", "大汗",
    "紫绀", "咯血", "呃逆", "肛门疼痛", "闭经", "经量增多", "不孕", "乳房肿块", "憋气", "气促",
    "眼花", "复视",
]
DRUG_POOL = [
    ...
    "头孢呋辛", "头孢曲松", "头孢克洛", "头孢地尼", "头孢吡肟", "阿莫西林克拉维酸钾", "哌拉西林他唑巴坦", "替硝唑", "奥硝唑", "诺氟沙星",
    "莫西沙星", "磺胺嘧啶", "呋喃妥因", "氟康唑", "伊曲康唑", "伏立康唑", "特比萘芬", "阿昔洛韦", "更昔洛韦", "恩替卡韦",
    "替诺福韦", "利福平", "异烟肼", "乙胺丁醇", "吡嗪酰胺", "阿苯达唑", "克霉唑", "单硝酸异山梨酯", "硝酸甘油", "地高辛",
    "胺碘酮", "普罗帕酮", "美西律", "维拉帕米", "地尔硫卓", "贝那普利", "培哚普利", "雷米普利", "氯沙坦", "替米沙坦",
    "坎地沙坦", "非洛地平", "尼莫地平", "吲达帕胺", "阿罗洛尔", "曲美他嗪", "辅酶Q10", "氟桂利嗪", "尼麦角林", "银杏叶提取物",
    "血脂康", "苯妥英钠", "丙戊酸钠", "卡马西平", "拉莫三嗪", "左乙拉西坦", "加巴喷丁", "普瑞巴林", "苯海索", "左旋多巴",
    "多巴丝肼", "普拉克索", "胞磷胆碱", "吡拉西坦", "依达拉奉", "舍曲林", "氟西汀", "帕罗西汀", "文拉法辛", "度洛西汀",
    "米氮平", "奥氮平", "利培酮", "喹硫平", "阿立哌唑", "碳酸锂", "劳拉西泮", "阿普唑仑", "唑吡坦", "佐匹克隆",
    "丁螺环酮", "泮托拉唑", "法莫替丁", "枸橼酸铋钾", "胶体果胶铋", "瑞巴派特", "替普瑞酮", "伊托必利", "匹维溴铵", "曲美布汀",
    "美沙拉嗪", "熊去氧胆酸", "腺苷蛋氨酸", "谷胱甘肽", "多烯磷脂酰胆碱", "水飞蓟素", "复方消化酶", "胰酶", "多索茶碱", "异丙托溴铵",
    "噻托溴铵", "氟替卡松", "福莫特罗", "特布他林", "丙卡特罗", "复方甲氧那明", "羧甲司坦", "标准桃金娘油", "乙酰半胱氨酸", "格列齐特",
    "格列喹酮", "瑞格列奈", "那格列奈", "西格列汀", "达格列净", "恩格列净", "吡格列酮", "艾塞那肽", "维格列汀", "阿仑膦酸钠",
    "骨化三醇", "碳酸钙D3", "非那雄胺", "坦索罗辛", "硫酸羟氯喹", "柳氮磺吡啶", "白芍总苷", "秋水仙碱", "别嘌醇", "非布司他",
    "苯溴马隆", "琥珀酸亚铁", "葡萄糖酸亚铁", "叶酸", "维生素B12", "利可君", "鲨肝醇", "重组人促红素", "低分子肝素钙", "利伐沙班",
    "达比加群酯", "维生素B1", "维生素B6", "维生素C", "维生素D", "维生素E", "复合维生素", "葡萄糖酸锌", "蛋白琥珀酸铁", "玻璃酸钠滴眼液",
    "普拉洛芬", "妥布霉素", "色甘酸钠", "糠酸莫米松", "卤米松", "丁酸氢化可的松", "他克莫司", "阿达帕林", "维A酸", "过氧苯甲酰",
    "酮替芬", "依巴斯汀", "氮卓斯汀", "索利那新", "米拉贝隆", "黄酮哌酯", "氨甲环酸",
]
DEPARTMENT_POOL = [
